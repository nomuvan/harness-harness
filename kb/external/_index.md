...
| AiToEarn | https://github.com/yikart/AiToEarn | AI活用コンテンツマーケティング全自動化プラットフォーム。Monetize/Publish/Engage/Createの4Agent構成。14プラットフォーム対応。MCP HTTP公開パターン。NestJS+Nx+Electronモノレポ。MIT License。GitHub 12,400+スター | 2026-03-26 | reference |
