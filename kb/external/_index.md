...
| AiToEarn | https://github.com/yikart/AiToEarn | AI活用コンテンツマーケティング全自動化プラットフォーム。Monetize/Publish/Engage/Createの4Agent構成。14プラットフォーム対応。MCP HTTP公開パターン。NestJS+Nx(2アプリ+16ライブラリ)モノレポ。nest-mcpモジュール。MIT License。GitHub 12,400+スター | 2026-03-27 | reference |
| claude-peers-mcp | https://github.com/louislva/claude-peers-mcp | Claude Code複数インスタンス間のP2Pアドホックメッセージング。Broker+SQLiteによるピア発見・メッセージルーティング。MCPチャネルプロトコルでリアルタイム配信。TypeScript/Bun。ライセンス未明示。GitHub 1,200+スター | 2026-03-26 | reference |
