...
last_patrol: "2026-04-05"
standard: agentskills.io (33 platforms confirmed)
tracked_skills: 10
...
| [anthropics/skills](https://github.com/anthropics/skills) | Anthropic公式 | 公式スキル実装例（115K+ stars） |
...
| [skills.sh](https://skills.sh/) | コミュニティ | スキルディレクトリ兼リーダーボード（90K+件） |
