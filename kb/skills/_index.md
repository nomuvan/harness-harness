...
last_patrol: "2026-04-18"
standard: agentskills.io (37+ platforms confirmed)
tracked_skills: 10
...
| [anthropics/skills](https://github.com/anthropics/skills) | Anthropic公式 | 公式スキル実装例（120K+ stars） |
...
| [skills.sh](https://skills.sh/) | コミュニティ | スキルディレクトリ兼リーダーボード（91K+件。find-skills が 1.1M installs でトップ） |
