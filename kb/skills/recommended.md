...
| **frontend-design** | UI/UX | anthropics/skills (211K installs) | create-harness | 50+視覚スタイル、本番品質UI生成 |
...
| **find-skills** | ディスカバリー | vercel-labs (750K installs) | create-harness, patrol-docs | スキル検索・発見ユーティリティ |
