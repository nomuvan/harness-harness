...
| **frontend-design** | UI/UX | anthropics/skills (310K installs) | create-harness | 50+視覚スタイル、本番品質UI生成 |
...
| **find-skills** | ディスカバリー | vercel-labs (1.1M installs、トップ) | create-harness, patrol-docs | スキル検索・発見ユーティリティ |
