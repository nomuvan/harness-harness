...
# ナビゲーション
cmux browser surface:M navigate "https://chatgpt.com/share/..."
...
**ChatGPT共有リンク/SPAページ取得パターン**:
```bash
cmux browser open "https://chatgpt.com/share/..." # → surface:M
sleep 5  # JSレンダリング待ち
...
```bash
# デスクトップ通知
cmux notify --title "タスク完了" --body "ハーネス生成が完了しました"
...
cmux notify --title "完了" --body "ハーネス生成が完了しました"
cmux clear-progress
```
